...
const LivePaymentSchema = new mongoose_1.Schema({
    viewer: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
...
exports.default = mongoose_1.default.model('LivePayment', LivePaymentSchema);
