  ...
  return (
    <div className="min-h-screen bg-[#15171B] text-white flex flex-col font-sans">
      <SEO 
        ...
        description="Looking for an anonymous chat website? Vibelly offers free, secure, and fully anonymous chat rooms and random video calls to keep your identity private."
        canonicalUrl="/anonymous-chat"
      />
      <BlinkingDotsGrid />
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section className="relative flex flex-col items-center justify-center text-center px-6 pt-20 pb-16 md:pt-32 md:pb-24 max-w-4xl mx-auto w-full">
          ...
          >
            Chat freely without giving up your email, phone, or identity. Vibelly is the safest, fastest, and most aesthetic platform on the internet.
          </motion.p>
