...
export default function ChatWithGirls() {
  ...
  return (
    <div className="min-h-screen bg-[#15171B] text-white flex flex-col font-sans">
      <SEO 
        ...
        description="Vibelly is the best platform for random video chat without login. Start connecting instantly in secure video rooms with strangers."
        canonicalUrl="/chat-with-girls"
      />
      <BlinkingDotsGrid />
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section className="relative flex flex-col items-center justify-center text-center px-6 pt-20 pb-16 md:pt-32 md:pb-24 max-w-4xl mx-auto w-full">
          ...
          >
            Jump straight into the action. Start chatting instantly in one click. Vibelly is the safest, fastest, and most aesthetic platform on the internet.
          </motion.p>
        ...
        <ShareButtons
          title="Random Video Chat Without Login | Vibelly"
          description="Start random video chat without login — instant stranger matching with HD video, free and anonymous."
        />
